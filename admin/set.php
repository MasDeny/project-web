    ...
    <div id="home" class="tab-pane fade in active">
      <h3>Tambah Admin</h3>
         <div class="form-group">
					<label for="id_petugas">id_petugas :</label><br>
					<input type="text" maxlength="50"name="id_petugas" placeholder="id_petugas" class="form-control" id="id_petugas" required>
				</div>
     ...
     <div class="form-group">
                ...
                <div class="form-group">
					...
					<input type="text" maxlength="50" name="nip" placeholder="Nip" class="form-control" id="Nip" required>
				</div>
                <div class="form-group">
...
<?php
	...
	if(isset($_POST['insert'])){
		...
		$sql = "INSERT INTO petugas (id_petugas, nama, nip, jenis_kelamin, username, password) VALUES ('$id','$nama', '$nip', '$jenis_kelamin', '$username', '$Password');";
